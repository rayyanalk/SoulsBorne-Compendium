<?php
$isDeleted = false;
if (!isset($_GET['idgear']) || empty($_GET['idgear'])) {

  $error = "Invalid Gear Set";
...
<body>
  ...
  <div class="row">
    <h1 class="col-12 mt-4" id="titleH">Gear Dismantling</h1>
  </div>
  <div class="container">
    <div class="row mt-4">
      <div class="col-12">
        ...
        <?php if (isset($error) && !empty($error)): ?>
          <div class="text" style="color:white;"> <strong>
              <?php echo $error; ?>
            </strong>
          </div>
        <?php endif; ?>
        ...
        <?php if ($isDeleted): ?>
          <div class="text" style="color:orangered;">Gear set successfully dismantled. Praise the Sun!</div>
        <?php endif; ?>
    ...
    <div class="row mt-4 mb-4">
      <div class="col-12">
        <a href="gear_display.php" role="button" class="btn" style="background-color:black; color:red;">Back to Gear
          Repository</a>
        <a href="add_gear.php" role="button" class="btn" style="background-color:red; color:black;">Add Additional Gear
          Sets</a>
      </div>
    </div>
  </div>
